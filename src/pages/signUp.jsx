  ...
  return (
    <div className="bg-[url('./assets/background/shopibag-bg.png')] bg-cover bg-center bg-no-repeat bg-fixed min-h-screen w-full">
     ...
     <form onSubmit={() => {
      ...
      <h2 className='mb-5 text-2xl font-bold text-center text-blue-700'>Sign Up</h2>
      <input
        type="email"
        name="email"
        id="emailID"
      ...
      <div className='flex gap-2 items-center'>
        <input type="checkbox" name="checkbox" id="checkboxID" className='w-5 h-5' />
        <label htmlFor="checkboxID" className='accent-blue-500 text-blue-700 text-md'>
          Remember Me
        </label>
      </div>
      <button type="submit" className='w-full h-20 bg-blue-500 rounded-full mt-2 text-xl font-bold text-white hover:text-gray-600'>Create Account</button>
