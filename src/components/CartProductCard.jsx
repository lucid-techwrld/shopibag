  ...
  return (
    <div className="flex items-center justify-between bg-white shadow-md rounded-lg p-4 mb-4">
      <div className="flex items-center gap-4">
        <img
          src={product.productId.imageUrl || "/placeholder-image.png"} // Fallback for image
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            {"$" + (formatPrice(product.productId.price) || "0.00")}
          </p>{" "}
          {/* Fallback for price */}
        </div>
      </div>
      <div className="flex items-center gap-4">
        ...
        />
        <p className="font-bold">{product.quantity || 0}</p>{" "}
